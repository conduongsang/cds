        ...
        <ul class="sidebar-menu">
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/config.html">
                            <span class="ico ico_config"></span> <span class="tit">Cấu hình</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/groups.html">
                            <span class="ico ico_group"></span> <span class="tit">Nhóm quyền</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/users.html">
            ...
            <li class="">
                <a href="http://dreamholidays.vn/admin.php/vn/register.html">
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/slider.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Slider</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/service.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Dịch vụ</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/utility.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Thông tin bổ ích</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/shares.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Tin tức</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/survey.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Khảo sát</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/partner.html">
            ...
            <li class="">
                <a href="http://dreamholidays.vn/admin.php/vn/introduce.html">
                    <span class="ico ico_menu_introduce"></span> <span class="tit">Giới thiệu</span>
                    <!--<small class = "label pull-right bg-yellow">12</small>-->
                </a>
            </li>
            <li class="">
                <a href="http://dreamholidays.vn/admin.php/vn/auto.html">
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/newscat.html">
                            <span class="ico ico_menu_child"></span> <span class="tit">Danh mục tin tức</span>
                            <!--<small class = "label pull-right bg-yellow">12</small>-->
                        </a>
                    </li>
                    <li class="">
                        <a href="http://dreamholidays.vn/admin.php/vn/news.html">
